// From https://github.com/PaulStoffregen/Arduino-1.0.6-Teensyduino/blob/master/build/shared/examples/ArduinoISP/ArduinoISP.ino
// Arduino ISP with SPI included
